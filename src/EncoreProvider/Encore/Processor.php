...
namespace Effectra\Core\EncoreProvider\Encore;

use Effectra\Core\EncoreProvider\Encore\Contracts\DataGather;
use Effectra\Core\EncoreProvider\Encore\Contracts\EntryData;
use Effectra\Core\EncoreProvider\Encore\Exceptions\ProcessorException;
use Effectra\Core\EncoreProvider\Encore\Integrity;

/**
 * Class Processor
 * @package Effectra\Core\EncoreProvider\Encore
 */
class Processor
{
